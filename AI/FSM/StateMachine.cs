...
namespace Binocle.AI.FSM
{
	public class StateMachine<T>
	{
		...
		public R changeState<R>() where R : State<T>
		{
			...
			Assert.IsTrue( _states.ContainsKey( newType ), string.Format("{0}: state {1} does not exist. Did you forget to add it by calling addState?", GetType(), newType) );
